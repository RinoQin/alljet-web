...
<html>
	<head>
		...
		<!--[if lte IE 8]><script src="../assets/plugins/css/ie/html5shiv.js"></script><![endif]-->
		<script src="${request.contextPath}/assets/plugins/js/jquery.min.js"></script>
		<script src="${request.contextPath}/assets/plugins/js/jquery.dropotron.min.js"></script>
